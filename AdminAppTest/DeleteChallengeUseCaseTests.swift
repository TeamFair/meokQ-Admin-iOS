...
final class DeleteChallengeUseCaseTests: XCTestCase {
    ...
    // 이미지 아이디가 있어서 이미지 삭제 성공 > 챌린지 삭제 성공
    // 이미지 아이디가 있어서 이미지 삭제 실패 > 챌린지 삭제 안함
    // 이미지 아이디가 있어서 이미지 삭제 실패&406에러 > 챌린지 삭제 성공
    // 이미지 아이디가 있는데 길이가 0이면 > 챌린지 삭제
    // 이미지 아이디가 없어서 챌린지 삭제만 수행 > 성공
